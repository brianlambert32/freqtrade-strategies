...
class TheForceV72(IStrategy):
  
    INTERFACE_VERSION = 2
    
        
    ##############################################################################
    ##                       THE FORCE ver 7 by Ofesad                          ##
    ##                                                                          ##
    ...
    #   I do not recommend running it live until further development.            #
    #                          TEST IT BEFORE USING IT                           #
    ##############################################################################
    ##                               DONATIONS                                  ##
    #   Some of you ask me for my address to sent donations.                     #
    #   I never ask'd for nothing in return when sharing this,                   #
    #   but I would accept'em as a token of appreciation.                        #
    #----------------------------------------------------------------------------#
    #   BTC: 1Pmx5Sc8n2cY2wf5BQ3W7TTSDangphnzUW                                  #
    #   ETH / USDT / USDC: 0x253d7384785603444767da64c9a1b650b41638c5            #                 
    ##############################################################################
    ...
    minimal_roi = {
        ...
        #   V7 roi disabled to improve profit thanks to Geroge Z idea
		"0": 10 
    }
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # VOLUME variation added in V7 thanks to the idea of revolover
                ...
                (
                    (
                        ( #Original sell condition
                            (dataframe['slowk'] <= 90)  & (dataframe['slowd'] <= 90)
                        )
                        |
                        ( #V3 added based on SmoothScalp
                            (qtpylib.crossed_above(dataframe['slowk'], 80))
							|
                            (qtpylib.crossed_above(dataframe['slowd'], 80))
                        )
                    )
                    &
                    ( #Original sell condition
